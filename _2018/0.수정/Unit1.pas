...
//         Form3.Memo1.Lines.Add('창이름복원:'+BasicTitle);
      ...
      begin
         ...
         Handle_2 := FindWindow(nil, PChar('주인'));
         Handle_3 := FindWindow(nil, PChar('노예'));
{$IFDEF SALBO}
//         DoolGi.Timer_DOOLGI.Interval := 10;
...
//   PostMessage(Handle_1, WM_KEYDOWN, VK_SHIFT, 0); // 0 공증
//   PostMessage(Handle_1, WM_KEYDOWN, VK_OEM_COMMA, 0); // 0 공증
//   PostMessage(Handle_2, WM_KEYDOWN, VK_SHIFT, 0); // 0 공증
//   PostMessage(Handle_2, WM_KEYDOWN, VK_OEM_COMMA, 0); // 0 공증
//   PostMessage(Handle_3, WM_KEYDOWN, VK_SHIFT, 0); // 0 공증
//   PostMessage(Handle_3, WM_KEYDOWN, VK_OEM_COMMA, 0); // 0 공증

   PostMessage(Handle_1, WM_KEYDOWN, VK_CONTROL, 0); // 0 공증
   PostMessage(Handle_1, WM_KEYDOWN, 82, 0); // 0 공증
