...
type
  TForm1 = class(TForm)
    ...
    Timer_BMoon_Move_Sub1: TTimer;
    Timer_BMoon_Move_Sub2: TTimer;
    Timer_BMoon_Move_Sub3: TTimer;
    Timer_BMoon_Move_Sub4: TTimer;
    ...
    procedure Timer_BMoon_Move_Sub1Timer(Sender: TObject);
...
//   Timer1.Enabled := True;                  //_dev
               ...
               begin
                  ...
                  MessageDlg(''''+Cbx_Type.Text+''' 없음',mtError, [mbOK], 0);
                  Exit;
               end;
...
begin
//   Memo1.Lines.Add('현재맵:'+IntToStr(Now_Map)+' 이전맵:'+IntToStr(Before_map)+' ElveFlag:'+BoolToStr(ElveFlag)
//   );
...
procedure TForm1.Timer_BMoon_Move_Sub1Timer(Sender: TObject);
begin
   try
//   {$IFDEF _LOG_} memo1.Lines.Add(FormatDateTime('HH:NN:SS ZZZ ',now)+' ---------Timer_Move ON!!!'); {$ENDIF}
      if Now_Map = map_BMoon_F0 then
