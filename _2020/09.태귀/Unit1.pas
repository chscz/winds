...
//         Bitblt(bmp_cap_Timer.Canvas.Handle, 0, 0, 48, 5, aDC, 400, 80, SRCCOPY);
         // 귀력
//         Bitblt(X_1.Canvas.Handle, 0, 0, 5, 5, aDC, 718, 120, SRCCOPY);
//         Bitblt(Y_1.Canvas.Handle, 0, 0, 5, 5, aDC, 723, 120, SRCCOPY);
         // 이미지 수정
         Bitblt(X_1.Canvas.Handle, 0, 0, 4, 6, aDC, 718, 119, SRCCOPY);
         Bitblt(Y_1.Canvas.Handle, 0, 0, 4, 6, aDC, 724, 119, SRCCOPY);
...
//         Pos_Y := (Check_Num(Y_10)*10) + Check_Num(Y_1);
         ...
         Label4.Caption := Check_Num(X_1);
         Label5.Caption := Check_Num(Y_1);

//         Label4.Caption := GR_str;
         GR_int := StrToInt(GR_str);
//         GR_int := 17;
