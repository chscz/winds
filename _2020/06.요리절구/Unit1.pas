...
type
   TDDD = class(TForm)
    ...
    procedure Rb_3Click(Sender: TObject);
...
begin
   ...
   while flag do
   begin
      if Rb_3.Checked then //요리
      begin
         keybd_event(VK_ESCAPE ,0,0,0);
         Delay(50);
         Keybd_Event(VK_SHIFT, MapVirtualKey(VK_SHIFT, 0), KEYEVENTF_EXTENDEDKEY, 0);
         Keybd_Event(VkKeyScan('i'), MapVirtualKey(VK_END, 0), KEYEVENTF_EXTENDEDKEY, 0);
         Keybd_Event(VkKeyScan('i'), MapVirtualKey(VK_END, 0), KEYEVENTF_EXTENDEDKEY or KEYEVENTF_KEYUP, 0);
         Keybd_Event(VK_SHIFT, MapVirtualKey(VK_SHIFT, 0), KEYEVENTF_EXTENDEDKEY or KEYEVENTF_KEYUP, 0);
         Delay(200);

         for I := 0 to ComboBox4.ItemIndex + 1 do
         begin
      ...
      begin
         ...
         if ComboBox1.ItemIndex <> 10 then
            keybd_event(96 + ComboBox1.ItemIndex,0,0,0)
         else begin
            keybd_event(96 + 1,0,0,0);
         ...
         begin
            ...
            keybd_event(VK_RETURN ,0,0,0);
            Delay(100);
            keybd_event(96 + ComboBox2.ItemIndex,0,0,0);
            Delay(100);
            keybd_event(VK_RETURN ,0,0,0);
            Delay(100);
         end;
         ...
         begin
            ...
            keybd_event(VK_RETURN ,0,0,0);
            Delay(100);
            keybd_event(96 + ComboBox3.ItemIndex,0,0,0);
            Delay(100);
            keybd_event(VK_RETURN ,0,0,0);
            Delay(100);
         end;
...
procedure TDDD.Rb_1Click(Sender: TObject);
begin
...
procedure TDDD.Rb_2Click(Sender: TObject);
begin
   ComboBox1.Enabled := True;
   ComboBox2.Enabled := True;
   ComboBox3.Enabled := True;
...
procedure TDDD.Rb_3Click(Sender: TObject);
begin
