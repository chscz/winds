...
//      Bitblt(btm.Canvas.Handle, 0, 0, aE_X, aE_Y, aDC, aS_X, aS_Y, SRCCOPY);
      case ComboBox1.ItemIndex of
         0: Bitblt(btm.Canvas.Handle, 0, 0, 10, 12, aDC, 914, 737, SRCCOPY);
         1: Bitblt(btm.Canvas.Handle, 0, 0, 10, 14, aDC, 923, 737, SRCCOPY);
         2: Bitblt(btm.Canvas.Handle, 0, 0, 10, 14, aDC, 931, 737, SRCCOPY);
         3: Bitblt(btm.Canvas.Handle, 0, 0, 10, 14, aDC, 972, 737, SRCCOPY);
         4: Bitblt(btm.Canvas.Handle, 0, 0, 10, 14, aDC, 980, 737, SRCCOPY);
         5: Bitblt(btm.Canvas.Handle, 0, 0, 10, 14, aDC, 989, 737, SRCCOPY);
      end;
      Image1.Height := btm.Height;
      Image1.Width := btm.Width;
                                                                   }
      btm.LoadFromFile('C:\Users\c\Desktop\새 폴더 (2)\둠.bmp');
