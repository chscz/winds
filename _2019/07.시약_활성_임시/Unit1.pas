...
begin
   ...
   begin
      ...
      begin
         Form1.Btn_StartClick(Form1.Btn_Start1);
         Result := 1;
      end
      else if (KeyCode = 256) and (PKeyHook.vkCode = VK_F2) then
      begin
         Form1.Btn_StopClick(Form1.Btn_Stop1);
         Result := 1;
      end
      else
         // 필터링 된 키가 아니라면 계속 진행
...
//      Sleep(200);
      ...
      Delay(1000);
      keybd_event(VkKeyScan(Form1.Edt_Key1.Text[1]),0,0,0); //열쇠
      Delay(1000);
