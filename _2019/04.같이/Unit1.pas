...
begin
   ...
   begin
      ...
      begin
         ...
         begin
            if wHandle_2 > 0 then PostMessage(wHandle_2, WM_KEYDOWN, PKeyHook.vkCode, 0);
            if wHandle_3 > 0 then PostMessage(wHandle_3, WM_KEYDOWN, PKeyHook.vkCode, 0);
            if wHandle_4 > 0 then PostMessage(wHandle_4, WM_KEYDOWN, PKeyHook.vkCode, 0);
         end;
      end;
...
begin
   Showmessage('- 오른아래 숫자는 초상키(변경가능)' + #13#10 +
